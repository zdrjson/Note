...
//        _yyLabel.backgroundColor = [UIColor g]
...
- (void)viewDidLoad {
    ...
    if ([UIVisualEffectView class]) {
        toolbar = [[UIVisualEffectView alloc] initWithEffect:[UIBlurEffect effectWithStyle:UIBlurEffectStyleLight]];
    } else {
    ...
    label.text = @"UILable/YYLabel(Async):";
...
- (void)setAsync:(BOOL)async {
    _async = async;
    [self.tableView.visibleCells enumerateObjectsUsingBlock:^(YYTextAsyncExampleCell *cell, NSUInteger idx, BOOL * _Nonnull stop) {
        cell.async = async;
