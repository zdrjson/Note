...
#指定项目地址
workspace_path="$project_path/花木金融.xcworkspace"
#指定输出路径
output_path="/Users/json/Desktop/Archive"
#指定输出归档文件地址
...
#上传到fir
fir publish ${ipa_path} -T e0b69232c7323284fd9fef817c172368 -c "${commit_msg}"
...
#删除打包Archives
rm -rf —-* "/Users/json/Library/Developer/Xcode/Archives"
